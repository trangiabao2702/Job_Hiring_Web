                ...
                mailer.sendMail(user.email, `Email xác thực thông tin tài khoản ứng viên ${user.name}`,
                    ...
                    * {
                    ...
                    <div class="v-text-align" style="color: #333333; line-height: 180%; text-align: left; word-wrap: break-word;">
                        <p style="font-size: 14px; line-height: 180%;"><em><span style="font-size: 18px; line-height: 32.4px; font-family: Lato, sans-serif;"><strong><span style="line-height: 32.4px; font-size: 18px;">Xin chào Dương Minh Hiếu, </span></strong></span></em></p>
